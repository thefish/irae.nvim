...
function M.get_groups()
    ...
    local O = require('irae.config').options
    ...
    G.DashboardProjectTitle = { fg = C.light_blue.base, bold = true }
    ...
    -- Mini Statusline.
    local LC = require 'lualine.themes.irae'
    ...
    G.NotifyDEBUGBorder = { fg = C.light_blue.bright }
    G.NotifyDEBUGIcon = { fg = C.light_blue.bright }
    G.NotifyDEBUGTitle = { fg = C.light_blue.bright, bold = true }
    ...
    if O.telescope.style == 'flat' then
        ...
        G.TelescopeTitle = { bg = C.light_blue.base, fg = C.black0, bold = true }
    ...
    G.texSpecialChar = { fg = C.light_blue.base }
